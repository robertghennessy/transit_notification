...
from transit_notification import db_commands
import responses
import json
import configparser


config_filename = "test_config.ini"
...
def test_setup(client, app):
    with open("./test_jsons/test_operators.json", 'r') as f:
    ...
    with app.app_context():
        select = db.select(Operators).filter_by(id="SF")
