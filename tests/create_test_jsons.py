...
selected_lines = ['F', '14', '49', '33']
selected_stops = ['15829', '13230', '15553']
...
vehicle_test_cases = [{'Name': 'Schedule_0-Est_0',
                      ...
                      {'Name': 'Schedule_5-Est_Unknown',
                       'ScheduledArrival': dt.timedelta(minutes=5),
...
def modify_vehicle(vehicle_in: dict,
    ...
    df_onward_call, next_stop = modify_onward_calls(onward_call_df, cur_time, scheduled_arrival, estimated_arrival)
...
def main():
    ...
    create_stops_json(client, selected_operator, selected_stops, json_folder)
    ...
    create_stop_places_json(client, selected_operator, selected_stop, json_folder)
    create_timetable_json(client, selected_operator, selected_line, json_folder)
    create_modified_vehicles_timetable_json(client, selected_operator, selected_stop, json_folder)
